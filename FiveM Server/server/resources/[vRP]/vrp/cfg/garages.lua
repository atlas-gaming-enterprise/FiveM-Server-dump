...
cfg.garage_types = {
  ...
  ["High End"]  = {  -- 150k price cap
    ...
    ["tesla11"] = {"2011 Tesla Roadster",100000, ""},
    ["vc7"] = {"2014 Corvette",138000, ""},
  ...
  ["Mid Range"] = { -- 75k price cap
    _config = {vtype="car",blipid=50,blipcolor=4},
    ["r8v10"] = {"Audi R8",70000, ""},
    ["sentinel"] = {"sentinel", 45000, ""},
    ["raptor12"] = {"Ford Raptor 2012",40000, ""},
    ["bestiagts"] = {"Bestia GTS",60000, ""},
    ["blista"] = {"Blista Compact",42000, ""},
	["gmt900escalade"] = {"Cadillac Escalade",38000, ""},
    ["16charger"] = {"Dodge Charger 2016",35000, ""},
    ["genublu"] = {"2013 Hyundai Genesis",25000, ""},
    ["musty5"] = {"2005 Mustang GT",35000, ""},
    ["exemplar"] = {"Exemplar", 50000, ""},
    ["fusilade"] = {"Fusilade",36000, ""},
    ["gburrito"] = {"Gang Burrito",65000, ""},
    ["16challenger"] = {"Dodge Challenger",55000, ""},
	["demon"] = {"Dodge Demon",65000, ""},
    ["granger"] = {"Suburban",45000, ""},
	["rancherxl"] = {"Chevy Tahoe",35000, ""},
	["kuruma"] = {"Lancer Evo",35000, ""},
    ["zl12017"] = {"Chevy Camaro",62000, ""},
    ["300srt8"] = {"C300",60000, ""},
    ...
    ["vigero"] = {"Vigero",72000, ""},
    ["virgo"] = {"Virgo",65000, ""},
    ["srt8"] = {"Cherokee SRT (Redseats)",55000, ""},
	["srt8n"] = {"Jeep Grand Cherokee SRT",55000, ""}
  },
  ...
  ["Exotic Cars"] = {
    ...
    ["huracan"] = {"Lamborghini Huracan",220000, ""},
    ["lynx"] = {"Lynx",173000, ""},
    ...
    ["gtrublu"] = {"2010 GT-R SpecV",80000, ""},
    ["mcublu"] = {"2011 McLaren 12C",1600000,"7 - (less numner better car"},
    ["tropos"] = {"Tropos",180000, ""},
    ["it458"] = {"Ferrari 458 Italia",1500000, "9 - (less numner better car"},
    ["tyrus"] = {"Tyrus",550000, "5 - (less numner better car"},
    ["vacca"] = {"Vacca",340000, ""},
    ["voltic"] = {"Tesla Roadster 2020",150000, ""},
	["lp700"] = {"Lamborghini Aventador",120000, ""},
	["lp770"] = {"Lamborghini Centenario",150000, ""},
	["lp770r"] = {"Lambo Centenario (Topless)",350000, ""},
    ["prototipo"] = {"X80 Proto",27000000, "6 - (less numner better car"},
	["lykan"] = {"Lykan HyperSport",5000000, "3 - (less numner better car"},
  ...
  ["Starter Vehicles"] = {  -- 15k price cap
    ...
    ["mx5"] = {"MX-5 Roadster (Sticker)",9000, ""},
    ["mx5a"] = {"2007 Mazda MX-5 Roadster",9000, ""},
    ["regina"] = {"Regina",8000, ""},
 ...
 ----------   
  ["House Garage"] = {
	...
	["lp700"] = {"Lamborghini Aventador",120000, ""},
	["lp770"] = {"Lamborghini Centenario",150000, ""},
	["lp770r"] = {"Lambo Centenario",350000, ""},
	["le7b"] = {"RE-7B",2075000, "1 - (less numner better car"},
    ["sheava"] = {"ETR1",199500, "4 - (less numner better car"},
    ["schafter3"] = {"Schafter V12",700000, ""},
    ["ySbrImpS11"] = {"Subaru Impreza",200000, ""},
  ...
  ["police"] = {
    ...
    ["police"] = {"Cadet Car",0, "police"},
    ["police5"] = {"Dodge Charger",0, "police"},
    ["police5blue"] = {"Charger Blue",0, "police"},
    ["police6"] = {"Police CVPI",0, "police"},
    ["police7"] = {"Impala",0, "police"},
	["policeinsurgent"] = {"Police insurgent",0, "police"},
    ["policet"] = {"policet",0, "police"},
    ["sheriff"] = {"Sheriff",0, "police"},
    ["sheriff4"] = {"Sheriff SUV",0, "police"},
	["sheriffinsurgent2"] = {"sheriff insurgent",0, "police"},
    ["riot"] = {"SWAT Riot",0, "police"},
	["fbi"] = {"Unmarked Charger",0, "police"},
	["fbi2"] = {"Tahoe",0, "police"},
	["fbi3"] = {"FBI Tahoe Marked",0, "police"},
	["fbi4"] = {"Armored Suburban",0, "police"},
	["fbiinsurgent"] = {"Fbi Insurgent",0, "police"},
	["fbiriot"] = {"Fbi Riot",0, "police"},
	["hwaycar7"] = {"hwaycar7",0, "police"},
	["unmarked3"] = {"Unmarked Camry",0, "police"},
	["unmarked4"] = {"2016 Mustang UC",0, "police"},
	["unmarked8"] = {"Tahoe",0, "police"},
	["unmarked9"] = {"2008 UC Charger",0, "police"},
    ["2015polstang"] = {"Police mustang",0, "police"},
	["policeb"] = {"policeb",0, "police"},
	["CVPI1"] = {"CVPI1",0, "police"},
	["CVPI2"] = {"CVPI2",0, "police"},
	["CVPI3"] = {"CVPI3",0, "police"},
	["CVPI4"] = {"CVPI4",0, "police"},
	["06tahoe1"] = {"06tahoe1",0, "police"},
	["06tahoelib"] = {"06tahoelib",0, "police"},
	["cvpi1blue"] = {"cvpiblue",0, "police"},
	["cvpi2blue"] = {"cvpi2blue",0, "police"},
	["cvpifreedomblue"] = {"freedomblue",0, "police"},
	["cvpilasd1"] = {"lasd1",0, "police"},
	["cvpilasd2"] = {"lasd2",0, "police"},
	["fpis13"] = {"Taurus",0, "police"},
	["fpiu13"] = {"13Explorer",0, "police"},
	["fpiu16"] = {"16Explorer",0, "police"},
	["pgresley"] = {"VancouverExplorer",0, "police"},
	["pbuffalo2"] = {"Oracle",0, "police"},
	["psubby16"] = {"16Suburban",0, "police"},
	["pucvan1"] = {"UCVan",0, "police"},
	["pyosemite"] = {"UCTruck",0, "police"},
	["z01bimpalalib"] = {"z01bimpalalib",0, "police"},
	["z01blueimpala"] = {"z01blue",0, "police"}
  },
  
  ["Cadet"] = {
    _config = {vtype="car",blipid=56,blipcolor=38,permissions={"Cadet.vehicle"}},
    ["police7"] = {"police",0, "police"},
	["police"] = {"Cadet",0, "police"}
  },
  ...
  ["emergency"] = {
	...
	["Ambulance2"] = {"Ambulance2",0, "emergency"},
	["firetruk"] = {"firetruk",0, "emergency"},
	["firetruk2"] = {"firetruk2",0, "emergency"},
	["laddertruk"] = {"laddertruk",0, "emergency"},
	["contendred"] = {"contendred",0, "emergency"},
	["cvpifd"] = {"cvpifd",0, "emergency"},
    ["cvpivol"] = {"cvpivol",0, "emergency"},
	["evan"] = {"evan",0, "emergency"},
	["evan2"] = {"evan2",0, "emergency"},
	["firechief"] = {"firechief",0, "emergency"}
  },
