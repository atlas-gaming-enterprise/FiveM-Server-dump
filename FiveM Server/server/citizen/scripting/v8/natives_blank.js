 ...
 */
window.SetPlayerTalkingOverride = function (player, state) {
...
window.SetRuntimeTextureArgbData = function (tex, buffer, length) {
 ...
 */
window.SetRuntimeTexturePixel = function (tex, x, y, r, g, b, a) {
